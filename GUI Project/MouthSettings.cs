...
{
    public partial class MouthSettings : Form
    {
        ...
        public MouthSettings( Start startform )
        {
            InitializeComponent();
        ...
        private void MouthSettings_Load(object sender, EventArgs e)
        {
            for (int i = 0; i < originalform.m_mouths.Length; ++i)
            {
                pb[i].Image = originalform.m_mouths[i];
        ...
        private void pic_Click(object sender, EventArgs e)
        {
            ...
            {
                originalform.m_mouths[tblCell] = Image.FromFile(openFile.FileName);
                pb[tblCell].Image = originalform.m_mouths[tblCell];
            }
        ...
        private void clearAllButton_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < originalform.m_mouths.Length; ++i)
            {
                originalform.m_mouths[i] = null;
            }

            chooseDoneButton.Text = "Choose 6 Mouth Images";
        ...
        private void chooseDoneButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (openFile.ShowDialog() == DialogResult.OK)
                {
                    ...
                    {
                        originalform.m_mouths[idx] = Image.FromFile(file);
                        pb[idx].Image = originalform.m_mouths[idx];
