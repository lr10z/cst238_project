...
{
    public partial class EyeSettings : Form
    {
        ...
        public EyeSettings( Start startform )
        {
            InitializeComponent();
        ...
        private void EyeSettings_Load(object sender, EventArgs e)
        {
            for( int i = 0; i < originalform.m_eyes.Length; ++i )
            {
                pb[i].Image = originalform.m_eyes[i];
        ...
        private void pic_Click(object sender, EventArgs e)
        {
            ...
            {
                originalform.m_eyes[tblCell] = Image.FromFile(openFile.FileName);
                pb[tblCell].Image = originalform.m_eyes[tblCell]; 
            }
        ...
        private void clearAllButton_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < originalform.m_eyes.Length; ++i)
            {
                originalform.m_eyes[i] = null;
            }

            chooseDoneButton.Text = "Choose 6 Eye Images";
        ...
        private void chooseDoneButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (openFile.ShowDialog() == DialogResult.OK)
                {
                    ...
                    {
                        originalform.m_eyes[idx] = Image.FromFile(file);
                        pb[idx].Image = originalform.m_eyes[idx];
